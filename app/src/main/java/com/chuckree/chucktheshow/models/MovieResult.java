...
public class MovieResult {
    ...
    @SerializedName("genre_ids") private List<Integer> genre_ids = new ArrayList<>();
    ...
    @SerializedName("vote_count") private Integer vote_count;
    @SerializedName("video") private Boolean video;
    @SerializedName("vote_average") private Double vote_average;

    public MovieResult(String poster_path, Boolean adult, String overview, String release_date, List<Integer> genre_ids, Integer id, String original_title,
